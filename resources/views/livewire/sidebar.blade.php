...
<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="150" height="150" viewBox="0 0 702.000000 285.000000"
...
-56z"/>
                    ...
                    <div class="md:flex nav__dropdown-content-img"><img class="  ring-4 ring-indigo-300 rounded-full h-50 w-50 flex items-center justify-center..." src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}" >
                    </div>
                    @endif
                            <div class=" nav__dropdown-content">
                                <div class="md:flex  break-words tracking-wide text-gray-400  capitalize ">Bienvenido: {{ Auth::user()->name }} {{ Auth::user()->lastname }}</div>
                                <div class="md:flex  break-words  tracking-wide text-gray-400  ">Usuario: {{ Auth::user()->email }}</div>
                            </div>
                        </div>
  ...
  <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" />
                            ...
                            <div class="nav__dropdown">
                                <a href="#" class="nav__link">
                                    ...
                                    <span class="nav__name">Cupones</span>
                                    <i class='bx bx-chevron-down nav__icon nav__dropdown-icon'></i>
                                </a>
                            </div>
